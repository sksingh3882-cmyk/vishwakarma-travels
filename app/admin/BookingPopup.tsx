...
const declaration: CSSProperties = { marginTop: 2, borderLeft: "4px solid #f97316", background: "#fff7ed", borderRadius: 10, padding: "8px 10px", fontSize: 11.7, lineHeight: 1.15 };
const thankYou: CSSProperties = { marginTop: 2, textAlign: "center", color: "#0b2d6b", fontSize: 23, fontWeight: 950, letterSpacing: 1.1, lineHeight: 1 };
