...
.admin-shell form h2,.admin-shell section h2{color:#0b2d6b!important;margin-top:0!important;font-size:21px!important}.admin-shell input,.admin-shell select{background:#f8fafc!important;border:1px solid #cbd5e1!important;border-radius:14px!important;min-height:42px!important;font-weight:700!important;color:#0f172a!important}.admin-shell button{border-radius:14px!important}
