...
export default function Home() {
  ...
  const services = [
    { icon: "✈️", title: "One Way Drop Pickup", text: "View Ranchi/Kolkata airport fare page", link: "/airport-drop" },
...
const dateTimeBox: React.CSSProperties = { display: "flex", alignItems: "center", gap: 12, padding: "14px 14px", borderRadius: 18, border: "1px solid #fed7aa", background: "linear-gradient(135deg,#fff7ed,#ffffff)", boxShadow: "0 8px 18px rgba(249,115,22,.12)" };
