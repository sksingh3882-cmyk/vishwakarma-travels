...
const [showCover,setShowCover]=useState(true);
 ...
 const [form,setForm]=useState<F>(empty),[errors,setErrors]=useState<FormErrors>({}),[customers,setCustomers]=useState<any[]>([]),[bookings,setBookings]=useState<any[]>([]),[showSug,setShowSug]=useState(false),[showOldPickups,setShowOldPickups]=useState(true),[pending,setPending]=useState<any>(null),[notice,setNotice]=useState(false),[openDrop,setOpenDrop]=useState<"service"|"vehicle"|"date"|"time"|null>(null),[calMonth,setCalMonth]=useState(()=>new Date()),[customTime,setCustomTime]=useState({h:"07",m:"40",ap:"AM"});
