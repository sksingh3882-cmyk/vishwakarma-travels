...
.welcomePage::before{
  ...
  z-index:1;
        ...
        .userForm{position:absolute;top:300px;left:50%;transform:translateX(-50%);width:min(92vw,430px);padding:22px;border-radius:30px;background:rgba(255,255,255,.16);backdrop-filter:blur(22px);border:1px solid rgba(255,255,255,.28);box-shadow:0 25px 60px rgba(0,0,0,.35);z-index:3;animation:formUp 1s cubic-bezier(.16,1,.3,1) forwards}
