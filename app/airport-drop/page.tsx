...
const modalOverlay: React.CSSProperties = { position: "fixed", inset: 0, background: "rgba(0,0,0,.6)", display: "flex", justifyContent: "center", alignItems: "center", zIndex: 99999, padding: 16 };
const modalBox: React.CSSProperties = { background: "#fff", padding: 20, borderRadius: 20, width: "100%", maxWidth: 520 };
const closeButton: React.CSSProperties = { border: 0, background: "#ef4444", color: "#fff", borderRadius: 999, width: 34, height: 34, fontWeight: 900 };
const modalTitle: React.CSSProperties = { color: "#0b2d6b", fontSize: 24, fontWeight: 950 };
